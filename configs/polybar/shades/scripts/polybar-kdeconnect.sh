...
WIDTH=12
WIDTH_WIDE=24
THEME=/home/julliermy/.config/polybar/shades/scripts/rofi/launcher.rasi
...
DIR="/home/julliermy/.config/polybar/shades/scripts"
...
show_menu () {
    menu="$(rofi -sep "|" -dmenu -i -p "$DEV_NAME" -location $LOCATION -yoffset $YOFFSET -xoffset $XOFFSET -theme ~/.config/polybar/shades/scripts/rofi/launcher.rasi -width $WIDTH -hide-scrollbar -line-padding 4 -padding 20 -lines 5 <<< "Battery: $DEV_BATTERY%|Ping|Find Device|Send File|Browse Files|Unpair")"
    case "$menu" in
